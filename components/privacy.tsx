    ...
    <div className="container mx-auto px-4 md:px-6 py-8 md:py-12 mt-20">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">Last updated: November 07, 2024</p>
          ...
          <ul className="space-y-4 text-gray-700 list-disc pl-6">
            <li>
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong className="font-semibold text-gray-900">Account</strong>{" "}
            ...
            <li>
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                refers to FastNEAR, accessible from{" "}
                <a
          ...
          <ul className="space-y-4 text-gray-700 list-disc pl-6">
            ...
            <li>
              <p className="text-gray-700 leading-relaxed mb-4">Phone number</p>
            </li>
            <li>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <li>
              <p className="text-gray-700 leading-relaxed mb-4">Usage Data</p>
            </li>
          </ul>
          <h4 className="text-lg font-semibold text-gray-800 mt-6 mb-3">
            Usage Data
          ...
          <ul className="space-y-4 text-gray-700 list-disc pl-6">
            <li>By email: privacy@fastnear.com</li>
          </ul>
        </div>
      </div>
    </div>
